    ...
    <footer>
        <div class="container">
            <div class="footer-column">
                ...
                <p class="footer-bio" lang="en">[Short English footer description about the client goes here.]</p>
                <p class="footer-bio" lang="th">[Short Thai footer description about the client goes here.]</p>
            </div>
            <div class="footer-column">
